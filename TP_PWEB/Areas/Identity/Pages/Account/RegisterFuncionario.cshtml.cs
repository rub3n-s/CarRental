...
namespace A.Areas.Identity.Pages.Account
{
    public class RegisterModelFuncionario : PageModel
    {
        ...
        public RegisterModelFuncionario(
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    return RedirectToAction("IndexGestor", "UserRoles");
